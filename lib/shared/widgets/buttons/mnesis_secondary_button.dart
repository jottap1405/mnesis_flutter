...
/// Secondary button component for Mnesis application.
///
/// This is an outlined button used for secondary actions.
///
...
///
/// ## States
/// - **Normal**: Transparent background with white border
/// - **Hover**: Slight white overlay (user feedback)
...
/// )
/// ```
class MnesisSecondaryButton extends StatelessWidget {
  /// Creates a [MnesisSecondaryButton].
  ///
  /// The [text] parameter must not be null.
  /// The [onPressed] parameter is required. Pass null to disable the button.
  const MnesisSecondaryButton({
    required this.text,
        ...
        style: ButtonStyle(
          ...
          foregroundColor: WidgetStateProperty.resolveWith<Color>((states) {
            if (states.contains(WidgetState.disabled)) {
              return MnesisColors.textPrimary.withValues(alpha: MnesisColors.opacityDisabled);
            }
            return MnesisColors.textPrimary;
          }),
          side: WidgetStateProperty.resolveWith<BorderSide>((states) {
            if (states.contains(WidgetState.disabled)) {
              return BorderSide(
                color: MnesisColors.textPrimary.withValues(alpha: MnesisColors.opacityDisabled),
                width: MnesisSpacings.borderWidthButton,
              );
            }
          ...
          overlayColor: WidgetStateProperty.resolveWith<Color?>((states) {
            ...
            if (states.contains(WidgetState.hovered)) {
              return MnesisColors.textPrimary.withValues(alpha: 0.05);
            }
            return null;
          }),
